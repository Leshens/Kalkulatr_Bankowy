        ...
        <article>
            <section>
                <div  class="kalkulator">
                    ...
                    <div class="forma">
                        <p>Kwota Kredytu (zł)</p><p><input class="input" type="number" value="<?php if (isset($_POST['kwota1'])) echo $_POST['kwota1']?>" name="kwota1" placeholder="Podaj wilkość kwoty"> </p>
                        <p>Oprocentowanie w  skali roku (%)</p><p><input class="input" type="number" step="0.1" value="<?php if (isset($_POST['oprocentowane1'])) echo $_POST['oprocentowane1']?>" name="oprocentowane1" placeholder="Podaj oprocentowanie"> </p>
                        <p>Okres Kredytowania (miesiące)</p><p><input class="input" type="number" value="<?php if (isset($_POST['okres1'])) echo $_POST['okres1']?>" name="okres1" placeholder="Podaj okres"> </p>
                        <p>Liczba Rat w Skali Roku</p><p><input class="input" type="number" value="<?php if (isset($_POST['rok'])) echo $_POST['rok']?>" name="rok" placeholder="Podaj liczba rat w skali roku"> </p>
            ...
            <section>
                <div class="kalkulator">
                    ...
                    <div id="down" class="forma">
                        <p>Kwota lokaty (zł)</p><p><input class="input" type="number" value="<?php if (isset($_POST['kwota'])) echo $_POST['kwota']?>" name="kwota" placeholder="Podaj wilkość kwoty"> </p>
                        <p>Oprocentowanie (%)</p><p><input class="input" type="number" step="0.1" value="<?php if (isset($_POST['oprocentowane'])) echo $_POST['oprocentowane']?>" name="oprocentowane" placeholder="Podaj oprocentowanie"> </p>
                        <p>Okres lokaty (miesiące)</p><p><input class="input" type="number" value="<?php if (isset($_POST['okres'])) echo $_POST['okres']?>" name="okres" placeholder="Podaj okres"> </p>
